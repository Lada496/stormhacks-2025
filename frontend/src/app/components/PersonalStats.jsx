        ...
        <div style={styles.container}>
            ...
            <div style={styles.statContainer}>
                <div style={styles.statItem}>
                    <img src="/assets/star_stat.png" alt="Star Stat" style={styles.starImage} />
                ...
                <div style={styles.statItem}>
                    <img src="/assets/achievement_stat.png" alt="Achievement Stat" style={styles.starImage} />
                    <div style={styles.indStats}>
                ...
                <div style={styles.statItem}>
                    <img src="/assets/streak_stat.png" alt="Streak Stat" style={styles.starImage} />
                    <div style={styles.indStats}>
